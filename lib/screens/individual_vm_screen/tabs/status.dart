...
class Status extends StatefulWidget {
  ...
  Status({Key key, @required this.vm}) : super(key: key);
  @override
  _StatusState createState() => _StatusState(this.vm);
}

class _StatusState extends State<Status> {
  final VM vm;
  static List<VMStat> stats;
  _StatusState(this.vm);
  ...
  Future<Null> _onRefresh() async {
    await Client.requestVMStats(vm.node, vm.vmid, _selectedTimeInterval, "AVERAGE");
    setState(() {
      stats = DataHandler.getVMStatsList();
    });
  }
